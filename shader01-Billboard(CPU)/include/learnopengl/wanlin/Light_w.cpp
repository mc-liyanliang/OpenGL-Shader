...
void DirectLight::Draw(Shader_w shader, std::string name)
{
...
void PointLight::Draw(Shader_w shader, std::string name)
{
    shader.SetBool(name + ".on", on);
...
void SpotLight::Draw(Shader_w shader, std::string name)
{
    shader.SetBool(name + ".on", on);
    shader.SetVec3(name + ".position", position);
    shader.SetVec3(name + ".direction", direction);
